...
urlpatterns = patterns('',
    ...
    url(r'^asset/log/$', asset_log, name='asset_log'),
    ...
    url(r'^asset/edit_option/$', asset_option, name='asset_option'),
    url(r'^asset/edit_sethost/$', asset_sethost, name='asset_sethost'),
